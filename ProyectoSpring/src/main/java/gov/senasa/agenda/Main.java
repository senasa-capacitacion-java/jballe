...
import gov.senasa.agenda.services.AgendaService;

public class Main {

	public static void main(String[] args) throws ParseException {
		ApplicationContext context = new AnnotationConfigApplicationContext("gov.senasa.agenda");
		
		// TODO Auto-generated method stub
		System.out.println("Hi Polaco!");
		//PersonDAO personaDAO = new PersonDAOHib();
		PersonDAO personaDAO = context.getBean(PersonDAO.class);
		...
		for(Person pe : agendaService.obtenerPersonas()) {
			System.out.println("-------------------------------");
		...
		for(Person per : agendaService.obtenerPersonas()) {
			System.out.println("-------------------------------");
